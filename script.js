...
function sendEmail() {
    ...
    Email.send({
        SecureToken: "650fe783-21d1-4f67-8088-9f7a780035e4",
        To : 'amiranashvili2004@gmail.com',
        From : "amiranashvili2004@gmail.com",
...
function checkEmail() {
    const emailRegax = /^([a-z\d.-]+)@([a-z\d-]+)\.([a-z]{2,3})(\.[a-z]{2,3})?$/;
